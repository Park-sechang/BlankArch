...
import {
  DumpDataAsync
} from "./chunk-43OSVVCR.js";
import {
  VertexBuffer
} from "./chunk-C4IJJJ5Y.js";
import {
  Tools
} from "./chunk-7QUZ5BPP.js";
import {
  LoadFile,
  ReadFile,
  RequestFile
} from "./chunk-UQMJFNDD.js";
import {
  RegisterClass
...
var RGBDTextureTools = class {
  ...
  static ExpandRGBDTexture(texture) {
    ...
    const expandRGBDTexture = async () => {
      ...
      internalTexture.isReady = false;
      if (isWebGPU) {
        await import("./rgbdDecode.fragment-VBDZA4QG.js");
      } else {
        await import("./rgbdDecode.fragment-FQGART5K.js");
      }
  ...
  static async EncodeTextureToRGBD(internalTexture, scene, outputTextureType = 0) {
    if (!scene.getEngine().isWebGPU) {
      await import("./rgbdEncode.fragment-SST5UYSZ.js");
    } else {
      await import("./rgbdEncode.fragment-MKEXTZDL.js");
    }
...
//# sourceMappingURL=chunk-KHNS254J.js.map
