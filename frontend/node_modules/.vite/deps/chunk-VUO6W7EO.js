import {
  PerfCounter
} from "./chunk-QYWXBA6C.js";
import {
  BaseTexture,
  Plane,
  SerializationHelper,
  Texture
} from "./chunk-73AQSDF6.js";
import {
  Color3,
  __decorate,
  serialize,
  serializeAsColor4
} from "./chunk-TE6VHUIP.js";
import {
  Epsilon,
  Matrix,
  Quaternion,
  ...
  Vector3,
  _ObserveArray
} from "./chunk-QNVWOWTU.js";
import {
  HasStencilAspect,
  ThinEngine,
  WebGLDataBuffer,
  WebGLHardwareTexture
} from "./chunk-GAYIBPT3.js";
import {
  EffectWrapper
} from "./chunk-2NCTUOZC.js";
import {
  VertexBuffer
} from "./chunk-C4IJJJ5Y.js";
import {
  GetClass,
  RegisterClass
...
var RenderTargetTexture = class _RenderTargetTexture extends Texture {
  ...
  isReadyForRendering() {
    if (!this._dumpToolsLoading) {
      ...
      import("./dumpTools-UMDGK76F.js").then((module) => this._dumpTools = module);
    }
...
var PostProcess = class _PostProcess {
  ...
  _gatherImports(useWebGPU = false, list) {
    if (useWebGPU && this._webGPUReady) {
      list.push(Promise.all([import("./postprocess.vertex-E64VGEPO.js")]));
    } else {
      list.push(Promise.all([import("./postprocess.vertex-2Q7VUGQK.js")]));
    }
  }
  /**
...
ThinEngine.prototype.createPrefilteredCubeTexture = function(rootUrl, scene, lodScale, lodOffset, onLoad = null, onError = null, format, forcedExtension = null, createPolynomials = true) {
  const callback = async (loadData) => {
    ...
    const { DDSTools } = await import("./dds-ONZYJ5AE.js");
    const textures = [];
...
var ThinPassPostProcess = class _ThinPassPostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      ...
      list.push(Promise.all([import("./pass.fragment-WDEIF34U.js")]));
    } else {
      list.push(Promise.all([import("./pass.fragment-WUOQ4KYK.js")]));
    }
...
var ThinPassCubePostProcess = class _ThinPassCubePostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      this._webGPUReady = true;
      list.push(Promise.all([import("./passCube.fragment-WABG67JN.js")]));
    } else {
      list.push(Promise.all([import("./passCube.fragment-SEEZPRSG.js")]));
    }
    super._gatherImports(useWebGPU, list);
  }
  /**
...
var ProcessAsync = async (texture, width, height, face, lod) => {
  ...
  if (!engine.isWebGPU) {
    if (texture.isCube) {
      await import("./lodCube.fragment-CFHTEXSC.js");
    } else {
      await import("./lod.fragment-PZIDQIEG.js");
    }
  } else {
    if (texture.isCube) {
      await import("./lodCube.fragment-OVTMJECQ.js");
    } else {
      await import("./lod.fragment-MEWYH2VW.js");
    }
  }
  let lodPostProcess;
  if (!texture.isCube) {
...
//# sourceMappingURL=chunk-VUO6W7EO.js.map
